...
<div class=text-justify>
La población cuenta con los resultados para 535.254 estudiantes de los diferentes colegios del territorio colombiano, sobre la cual se ha definido un diseño muestral complejo de 3 etapas teniendo en cuenta que se desea conocer el puntaje obtenido por lo estudiantes de grado 11 en el área de ciencias naturales en la prueba saber. 
...
<div class=text-justify>
En estos resultados es notable que el estimador directo presenta falencias considerables respecto a los demás métodos, lo que puede detallarse en el coeficiente de variación y la diferencia de la estimación frente al resultado real poblacional. 
Los demás estimadores presentan un ajuste bastante bueno, en particular el estimador de razón, que presenta un coeficiente de variación de apenas 0.398 y 0.515 para los colegios oficiales y los no oficiales, respectivamente. Nótese que todos, excepto el estimador directo, obtuvieron un coeficiente de variación inferior al 1.6%
</div>
...
<div class=text-justify>
Para la estimación HBF se utilizó el dominio definido por los Municipios. La varibale dependiente es Ciencias naturales y las variables auxiliares son la mismas definidas en el estimador HBF del numeral anterior.
...
<div class=text-justify>
Para aquellos estimadores basados en modelos, o que en general hacen uso de variables auxiliares para la obtención de resultados, es conveniente calibrar las variables marginales en el diseño muestral, con el objetivo de reducir los coeficientes de variación. La idea central es que al realizar estimaciones sobre las variables auxiliares de la muestra, el resultado sea exactamente igual a los valores poblacionales.

A continuación se presentan dichas estimaciones, lo que en consecuencia muestran que se cumple el principio de representatividad:
</div>
